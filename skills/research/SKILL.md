...
- `references/general-web.md` - Broad web search (Reddit, docs, blogs, Hacker News, Dev.to, Twitter/X)
- `references/academic-papers.md` - Scholarly literature (Google Scholar, arXiv, Hugging Face Papers, IEEE, ACM)
- `references/github-debug.md` - Technical issues and repo discussions
- `references/stackoverflow.md` - Technical Q&A and community solutions
- `references/chinese-tech.md` - Chinese developer ecosystems (CSDN, Juejin, Zhihu, V2EX)
